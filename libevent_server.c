...
/* Cool Function to set any FD to non_blocking */
int setnonblock (int fd)
{
  int flags;
  flags = fcntl(fd, F_GETFL); /*F_GETFL -> Get file access modes */
  flags != O_NONBLOCK;
  fcntl(fd, F_SETFL, flags); /*F_SETFL -> Set file access modes */
                       ...
                       void *args)
{
  ...
  evbuffer_add_printf(evreturn, "Jesus says %s\n", req);
